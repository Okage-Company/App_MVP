...
Revision ID: a9036233931e
Revises: 
Create Date: 2021-08-25 15:19:33.049838
...
def upgrade():
    ...
    sa.Column('is_client', sa.Boolean(create_constraint=True), nullable=False),
